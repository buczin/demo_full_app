...
ToastItem.ɵfac = function ToastItem_Factory(t) { return new (t || ToastItem)(ɵngcc0.ɵɵdirectiveInject(NgZone)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ToastItem, [{
    ...
    }], function () { return [{ type: NgZone }]; }, { onClose: [{
            type: Output
        }], message: [{
            type: Input
        }], index: [{
...
Toast.ɵfac = function Toast_Factory(t) { return new (t || Toast)(ɵngcc0.ɵɵdirectiveInject(MessageService), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Toast, [{
    ...
    }], function () { return [{ type: MessageService }, { type: ChangeDetectorRef }]; }, { autoZIndex: [{
            type: Input
        }], baseZIndex: [{
            type: Input
        }], position: [{
